    ...
    <div class="row mx-0">
      <div class="col-sm-12 col-md-12 col-lg-12 px-0 features-wrapper d-flex flex-wrap">
        ...
        <div class="feature-item bg-theme">
          <div class="slick-carousel m-slides-0" data-slick='{"slidesToShow": 1, "arrows": false, "dots": true, "autoPlay": true}'>
            <div class="feature-item__content">
...
<section class="services-layout2 pb-90">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="slick-carousel" data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "arrows": false, "dots": true, "responsive": [ {"breakpoint": 992, "settings": {"slidesToShow": 2}}, {"breakpoint": 767, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'>
...
<section class="portfolio-standard portfolio-standard-carousel pt-20 pb-60 bg-gray">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="slick-carousel" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "arrows": true, "dots": true, "responsive": [ {"breakpoint": 992, "settings": {"slidesToShow": 2}}, {"breakpoint": 767, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'>
          <!-- portfolio item #1 -->
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="contact-panel mt--130">
          <div class="testimonials testimonials-layout1 bg-overlay bg-overlay-theme">
            ...
            <div class="slick-carousel" data-slick='{"slidesToShow": 1, "arrows": true, "dots": false, "infinite": true}'>
              ...
              <div class="testimonial-item">
                ...
                <div class="testimonial-item__meta">
                  <div class="testimonial-item__thumb">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/images/testimonials/thumbs/1.jpg" alt="author thumb">
              ...
              <div class="testimonial-item">
                ...
                <div class="testimonial-item__meta">
                  <div class="testimonial-item__thumb">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/images/testimonials/thumbs/2.jpg" alt="author thumb">
                  </div><!-- /.testimonial-thumb -->
                  <div>
              ...
              <div class="testimonial-item">
                ...
                <div class="testimonial-item__meta">
                  <div class="testimonial-item__thumb">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/images/testimonials/thumbs/3.jpg" alt="author thumb">
                  </div><!-- /.testimonial-thumb -->
                  <div>
                    <h4 class="testimonial-item__meta-title">John Peter</h4>
                    <p class="testimonial-item__meta-desc">7oroof Inc</p>
          ...
          <form method="post" action="<?= SITE_TEMPLATE_PATH ?>/php/contact.php" id="contactForm" class="contact-panel__form">
            <div class="row">
              <div class="col-sm-12">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                  <textarea class="form-control" placeholder="Additional Details!" id="contact-messgae" name="contact-messgae" required></textarea>
                </div>
              </div><!-- /.col-lg-12 -->
              ...
              <li>
                <? $APPLICATION->IncludeComponent(
                  ...
                  array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => SITE_TEMPLATE_PATH . "/inc/adress.php"
                  )
                ); ?>
              </li>
            </ul>
